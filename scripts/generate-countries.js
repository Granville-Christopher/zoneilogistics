...
const payload = countries.map(([name, lat, lng]) => ({ name, lat, lng }));
const out = `window.WORLD_COUNTRIES = ${JSON.stringify(payload, null, 2)};\n`;
const target = path.join(__dirname, '..', 'public', 'js', 'countries.js');
fs.writeFileSync(target, out);
console.log('Wrote', payload.length, 'countries to', target);
